...
export const sendVerificationMail = async (
  ...
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8f9fa; padding: 20px; border-radius: 8px; border: 1px solid #e0e0e0;">
    ...
    <div style="text-align: center; margin: 30px 0;"> 
      <a href="http://localhost:3003/callback/verify-email?token=${token}" 
    ...
    <p style="font-size: 14px; color: #999;">
      ...
      <br/>
      <a href="http://localhost:3003/callback/verify-email?token=${token}" style="color: #4CAF50;">http://localhost:3003/callback/verify-email?token=${token}</a>
    </p>
